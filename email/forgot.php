<?php
	...
	$email = $_GET['email'];
	$studentid = GetValue('SELECT studentid FROM tblstudent WHERE email=\''.$email.'\'');
	...
	function randomString($length = 5) {
        ...
        try {
			...
			mysqli_query($db_connection,'INSERT INTO tblreset SET token=\''.$otp.'\',studentid='.$studentid.' ');
