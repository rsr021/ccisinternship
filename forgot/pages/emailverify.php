...
$rs = mysqli_query($db_connection, "SELECT email FROM tblstudent WHERE email='$email'");
...
if ($rw) {
    ...
    echo '<a href="javascript:void();" onclick="loadPage(\'forgotpassword.php\',\'content_f\');">Back</a>';
}
?>
