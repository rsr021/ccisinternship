...
<h4 style="font-family:arial;">Application of Students Entry</h4>
<table border="1" style="font-family:arial narrow;border-collapse:collapse;width:100%">
        <thead>
            <tr>
                <th>#</th>
                <!--<th>Appli. Date</th>-->
        ...
        <tbody>
        <?
		$q = 'SELECT a.idnum, a.studentid, b.firstname, a.companyid, a.applicationdate, 
